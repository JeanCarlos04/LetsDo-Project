...
function CreateTask({ isUpdating, taskIdToUpdate }: CreateTaskProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const { setShowModal, showModal, addTask, updateTask } = useContextHook();
      ...
      {showModal.show && (
        ...
        >
          <article
            ...
            } bg-white border-1 border-gray-200 md:w-[400px] rounded-xl fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] shadow flex flex-col gap-4 p-4`}
          >
            ...
            >
              ...
              <input
                ...
                className="placeholder:font-semibold pl-3 h-10 border-1 rounded-md border-gray-300 focus:border-2 focus:border-[#366cb3] outline-none"
              ...
              <textarea
                ...
                className="placeholder:font-semibold p-2 border-1 h-16 rounded-md border-gray-300 focus:border-2 focus:border-[#366cb3] outline-none"
                placeholder={t("createTaskModal.descriptionInpuPlaceholder")}
              />
              <span className="text-red-500">
                {errors.description?.message}
              </span>
              <h3 className="font-[500] flex items-center gap-2">
              ...
              <div className="flex gap-6 justify-center">
                ...
                <button
                  ...
                  } cursor-pointer flex items-center gap-2 text-center font-semibold px-3 py-1 rounded-lg border-1 border-gray-300 duration-200`}
                >
                ...
                <button
                  ...
                  } cursor-pointer  text-center flex items-center gap-2 font-semibold px-3 py-1 rounded-lg border-1 border-gray-300 duration-200`}
                >
              ...
              <button className="mt-6 whitespace-nowrap rounded-lg bg-[#2764ba] text-white font-semibold py-[6px] px-3 cursor-pointer  hover:bg-[#3576d0] duration-100">
                {isUpdating === true
                  ? "Edit"
